...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> loginException(AccountException e, WebRequest wr) {
	...
	public ResponseEntity<ErrorDetails> loginException(BranchException e, WebRequest wr) {
		ErrorDetails ed = new ErrorDetails(LocalDateTime.now(), e.getMessage(), wr.getDescription(false));
		return new ResponseEntity<ErrorDetails>(ed, HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(TransactionException.class)
	public ResponseEntity<ErrorDetails> loginException(TransactionException e, WebRequest wr) {
		ErrorDetails ed = new ErrorDetails(LocalDateTime.now(), e.getMessage(), wr.getDescription(false));
		return new ResponseEntity<ErrorDetails>(ed, HttpStatus.BAD_REQUEST);
	}
